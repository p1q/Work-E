...
class Vacancy(models.Model):
    ...
    countries = ArrayField(models.CharField(max_length=50), verbose_name="Країни", null=True, default=list, blank=True)
    cities = ArrayField(models.CharField(max_length=50), verbose_name="Міста", null=True, default=list, blank=True)
    location = models.TextField(blank=True, null=True, verbose_name="Локація")
    is_remote = models.BooleanField(default=False, null=True, help_text="Чи є вакансія повністю віддаленою?")
    is_hybrid = models.BooleanField(default=False, null=True, help_text="Чи є вакансія гібридною?")
    languages = models.JSONField(blank=True, null=True, verbose_name="Мови")
    skills = ArrayField(models.CharField(max_length=100), blank=True, null=True, default=list, verbose_name="Навички")
    description = models.TextField(blank=True, null=True, verbose_name="Опис вакансії")
